const HomeIcon = ({ width, height, fillColor }) => (
  <svg fill={fillColor} width="800px" height="800px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" style={{ width: width, height: height }}>
